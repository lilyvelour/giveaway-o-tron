            ...
            <div className="relative flex-1" key={i}>
              ...
              <button
                ...
                onClick={() =>
                  setSettings((s) => ({
                    ...s,
                    blocklist: removeIdx(s.blocklist, i),
                  }))
                }
              >
                <FaTimes />
          ...
          <div className="flex flex-row justify-center items-center flex-1">
            ...
            <input
              ...
              onChange={(e) =>
                setSettings((s) => ({
                  ...s,
                  forfeitCommand: e.target.value.trim(),
                }))
              }
          ...
          <div className="flex-1 border border-purple-600 rounded-md flex relative">
            ...
            <button
              ...
              onClick={() =>
                setSettings((s) => ({
                  ...s,
                  autoAnnounce: s.autoAnnounce === undefined ? false : !s.autoAnnounce,
                }))
              }
            >
