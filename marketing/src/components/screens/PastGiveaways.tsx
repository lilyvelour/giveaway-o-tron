  ...
  return (
    <div className="flex flex-row justify-center items-center flex-1">
      ...
      <div className="bg-gray-600 px-2 py-1 rounded-r-md border-b border-purple-500 flex-1 overflow-ellipsis h-full max-w-full flex justify-center items-center">
        {typeof value === 'boolean' ? value ? <FaCheck /> : <FaTimes /> : (value as any)}
      </div>
    </div>
  )
}
const LIMIT_GIVEAWAY_LIST = 25
export default function PastGiveaways({
  ...
  return (
    <div className="mt-4 flex flex-col gap-5 flex-1 pb-5">
      <div>
        <h1 className="text-3xl flex items-center">Giveaway History</h1>
        <h2 className="text-xl flex items-center">Last {LIMIT_GIVEAWAY_LIST} Giveaways</h2>
      </div>
