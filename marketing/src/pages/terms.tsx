...
export default function Terms() {
  return (
    <div className="pt-4 pb-10 max-w-6xl mx-auto">
      ...
      <p>Welcome to Giveaway-o-tron!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use of Giveaway-o-tron's Website, located
        at https://giveaway-o-tron.mael.tech.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue to use
        Giveaway-o-tron if you do not agree to take all of the terms and conditions stated on this page.
      </p>
      ...
      <p>
        We employ the use of cookies. By accessing Giveaway-o-tron, you agreed to use cookies in agreement with the
        Giveaway-o-tron's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, Giveaway-o-tron and/or its licensors own the intellectual property rights for all
        material on Giveaway-o-tron. All intellectual property rights are reserved. You may access this from
        Giveaway-o-tron for your own personal use subjected to restrictions set in these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul className="list-inside">
        <li>Republish material from Giveaway-o-tron</li>
        <li>Sell, rent or sub-license material from Giveaway-o-tron</li>
        <li>Reproduce, duplicate or copy material from Giveaway-o-tron</li>
        <li>Redistribute content from Giveaway-o-tron</li>
      </ul>
      ...
      <p>
        ...
        areas of the website. Giveaway-o-tron does not filter, edit, publish or review Comments prior to their presence
        on the website. Comments do not reflect the views and opinions of Giveaway-o-tron,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their views and opinions. To the extent permitted
        by applicable laws, Giveaway-o-tron shall not be liable for the Comments or for any liability, damages or
        expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on
        this website.
      </p>

      <p>
        Giveaway-o-tron reserves the right to monitor all Comments and to remove any Comments which can be considered
      ...
      <p>
        You hereby grant Giveaway-o-tron a non-exclusive license to use, reproduce, edit and authorize others to use,
      ...
      <p>
        ...
        Giveaway-o-tron; and (d) the link is in the context of general resource information.
      </p>
      ...
      <p>
        ...
        you must inform us by sending an e-mail to Giveaway-o-tron. Please include your name, your organization name,
      ...
      <p>
        No use of Giveaway-o-tron's logo or other artwork will be allowed for linking absent a trademark license
        agreement.
      </p>
